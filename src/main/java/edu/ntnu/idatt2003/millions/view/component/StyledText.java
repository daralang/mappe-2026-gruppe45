 ...
 *   Label titleLabel = StyledText.headingThree("Navn");
 * </pre>
 */
public class StyledText extends Label {
    ...
    public static StyledText headingTwo() { return new StyledText("heading-2"); }

    /** @return a label styled as heading-2 */
    public static StyledText headingTwo(String text) { return new StyledText(text, "heading-2"); }

    /** @return an empty label styled as heading-3 */
    public static StyledText headingThree() { return new StyledText("heading-3"); }

    /** @return a label styled as heading-3 */
    public static StyledText headingThree(String text) { return new StyledText(text, "heading-3"); }
