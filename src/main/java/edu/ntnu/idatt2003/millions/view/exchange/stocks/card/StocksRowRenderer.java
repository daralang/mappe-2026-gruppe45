 ...
 * with the ticker (with optional owner badge), company name, current price,
 * weekly change in NOK and percent, a {@link SparklineChart} trend and
...
class StocksRowRenderer {
     ...
     * weekly change in NOK and percent, a sparkline trend and trade buttons.
     *
